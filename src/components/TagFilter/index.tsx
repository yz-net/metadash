...
export default function TagFilter(props: any) {
  ...
  return (
    <div className="flex max-h-full flex-col">
      <div className="flex flex-col bg-[#f0eee6] py-3 shadow-yale lg:h-20 lg:flex-row lg:px-0 lg:py-0">
        <div className="mb-2 flex flex-1 items-center px-3 pr-5 text-2xl lg:mb-0 lg:px-20">
